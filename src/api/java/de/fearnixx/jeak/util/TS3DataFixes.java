 ...
 * <p>
 * Not included are semantic issues like:
 * * {@link de.fearnixx.jeak.event.IQueryEvent.INotification.IClientEnter} using "ctid" instead of "cid" for the channel ID. (Fix not included in framework.)
 * * {@link de.fearnixx.jeak.event.IQueryEvent.INotification.IChannelEdited}s information being missing for edited descriptions and password. (Fix included in framework.)
 */
public class TS3DataFixes {
     ...
     * <p>
     * This will fix this issue by re-reading negative icon IDs as unsigned numbers.
     *
     ...
     */
    public static void ICONS_INVALID_CRC32(IDataHolder dataHolder, String propertyName) {
