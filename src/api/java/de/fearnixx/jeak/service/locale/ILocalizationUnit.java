...
public interface ILocalizationUnit {
     ...
     * If a context is not available or the code could not be translated into a
     * {@link Locale}, the default context will be returned.
     */
    ILocaleContext getContext(String ts3CountryCode);

    /**
     * Instructs the unit to load the specified (classpath) resource URI
     * and merge the values with already configured ones.
     * When the unit is not persisted yet, this will simply copy the templates from the ressource.
     *
     * <p>Fails silently when the resource could not be loaded. (Errors will be logged)
     */
     ...
     *
     * <p>The unit will read the keys "default" and "langs".
     * <ul>
     *     <li><strong>defaultLanguage</strong> being the country or locale code for the default context. E.g. "en"</li>
     *     <li><strong>"langs" containing keys which are either country
     *     or locale codes with a mapping from message id to template below.</strong></li>
     * </ul>
     */
