...
public interface ITS3Subject {
     ...
     * @implNote this only retrieves the permission explicitly set to this subject
     * and does not evaluate the whole context.
     */
     ...
     * Contrary to {@link #getTS3Permission(String)}, this evaluates the TS3 context including inheritance,
     * negated and skipped permissions.
